      ...
      <main className="bg-white py-[50px] px-5 max-w-[1000px] w-full mx-auto flex-1">
        <div className="w-full sm:w-1/2 mx-auto">
          ...
          <div className="text-center mb-5">
            <i className="far fa-bell-slash text-[50px] text-[#424242]" aria-hidden="true" />
          </div>
          ...
          <div className="text-center mb-5">
            ...
            <p className="text-[12px] text-[#878787] font-normal mt-[10px] mb-0">
              <i className="fas fa-exclamation-circle" /> 예약시 입력하신 이름과 휴대폰번호를 입력하시면 예약 취소하실 수 있는 현황이 나옵니다.
            </p>
          </div>
